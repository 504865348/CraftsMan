...
import com.joshua.craftsman.mode.CityData;
...
public class ChooseCityUtil implements View.OnClickListener, NumberPicker.OnValueChangeListener {
    ...
    public void createDialog(Context context, String[] oldCityArray, ChooseCityInterface cityInterface) {
        ...
        window.setContentView(R.layout.set_edit_myinfo_dialog_choose_city);
    ...
    private void setNumberPickerDividerColor(NumberPicker numberPicker) {
        ...
        for (Field pf : pickerFields) {
            if (pf.getName().equals("mSelectionDivider")) {
                ...
                try {
                    pf.set(picker, new ColorDrawable(context.getResources().getColor(R.color.red)));// pf.set(picker, new Div)
