...
public class VideoDetailPlus implements Serializable{
    ...
    public VideoDetailPlus(String id, String recordImage, String recordTitle, String name, String downloadUrl, String albumID, String idClassify, String albumImage, String title, String craftsmanName, String playTimes, String subscribeTimes, String classifyName, String introduction, String model, String isPay, String money, String isFocus, String buyTimes) {
        this.id = id;
